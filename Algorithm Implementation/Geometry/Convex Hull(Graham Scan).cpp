...
//A C++ program to find convex full of a set of points.
...
//A utility function for find next to top in a stack
...
//A function used by library function qsort() to sort an array
...
void convexHull(Point points[], int n)
{
    ...
    for(int i=1; i<n; i++) {
        ...
        //Pick the bottom-most or chose the leftmost
        //point in case of tie
